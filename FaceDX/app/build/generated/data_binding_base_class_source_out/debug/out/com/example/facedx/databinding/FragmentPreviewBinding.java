...
public final class FragmentPreviewBinding implements ViewBinding {
  ...
  private FragmentPreviewBinding(@NonNull LinearLayout rootView, @NonNull AppCompatButton btConfirm,
      @NonNull AppCompatButton btnCancel, @NonNull ImageView imagePreview) {
  ...
  public static FragmentPreviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btConfirm;
      AppCompatButton btConfirm = ViewBindings.findChildViewById(rootView, id);
      if (btConfirm == null) {
        break missingId;
      }
      ...
      return new FragmentPreviewBinding((LinearLayout) rootView, btConfirm, btnCancel,
          imagePreview);
    }
